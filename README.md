...
- [structslop: static analyzer for efficient struct packing for Go | by Emmanuel Odeke](https://medium.com/orijtech-developers/efficient-struct-packing-guided-pass-for-go-92255872ec72) 
### November 12, 2020 
...
- [Add header to every request in Go · Developer 2.0](https://developer20.com/add-header-to-every-request-in-go/) 
### July 24, 2020 
...
- [浅谈Kubernetes Service负载均衡实现机制](https://mp.weixin.qq.com/s/BLWc6WRwOt8NSKWBk18INw) 
### July 23, 2020 
...
- [Go HTTP 重用底层 TCP 连接需要注意的关键点 · GopherChina](https://gocn.vip/topics/10626) 
### June 29, 2020 
...
- [TiKV 的 MVCC（Multi-Version Concurrency Control）机制 | PingCAP](https://pingcap.com/blog-cn/mvcc-in-tikv/) 
### April 24, 2020 
...
- [论面向组合子程序设计方法 之 oracle - ajoo - ITeye博客](https://www.iteye.com/blog/ajoo-23309) 
- [论面向组合子程序设计方法 之 重构 - ajoo - ITeye博客](https://www.iteye.com/blog/ajoo-23314) 
### April 8, 2020 
